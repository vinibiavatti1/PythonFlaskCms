...
def process_list_view(context: str, list_name: str, title: str,
...
def process_create_view(context: str, list_name: str, title: str,
                        resource_type: str, properties: list[Any]) -> Any:
    """
    Create view wrapper.
    """
    list_url = get_admin_list_url(context, list_name)
...
def process_edit_view(context: str, list_name: str, title: str,
                      resource_type: str, properties: list[Any],
                      content_id: int) -> Any:
    """
    Edit view wrapper.
    """
    ...
    history = history_service.select_by_resource(content_id)
    return render_template(
        '/admin/content.html',
        page_data=dict(
            context=context,
...
def process_create_action(context: str, data: dict[str, Any],
                          list_name: str) -> Any:
    """
...
def process_edit_action(context: str, data: dict[str, Any],
...
def process_delete_action(context: str, list_name: str,
                          content_id: int) -> Any:
    """
