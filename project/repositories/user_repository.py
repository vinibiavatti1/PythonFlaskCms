...
def select_by_email_and_password(email: str, password: str) -> list[Any]:
    """
    ...
    sql = '''
        ...
        AND deleted = 0
    '''
    return database_utils.execute_query(sql, (email, password))
...
def select(id_user: int) -> Optional[Any]:
    ...
    '''
    return database_utils.execute_query(sql, (id_user,), single=True)
